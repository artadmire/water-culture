...
import { ChooseWrapAnimProps, ChooseWrapAnimStates, ChooseWrapProps, MainProps, MainStates } from './type';
...
class ChooseWrapAnim extends Component<ChooseWrapAnimProps, ChooseWrapAnimStates> {
    constructor(props: ChooseWrapAnimProps) {
        super(props);
        this.state = {
...
class ChooseWrap extends Component<ChooseWrapProps> {
    state = {
        area: [
            { key: '后湖院区' },
            { key: '谌家矶院区' }
